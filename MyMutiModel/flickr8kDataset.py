...
class MultiModalDataset(Dataset):
    ...
    def __getitem__(self, idx):
        image_url =image_path+ self.dataframe.iloc[idx]['image']
...
# 读取xlsx文件
image_path = '/input/archive/Images/'
data = pd.read_csv("/input/archive/captions.txt")
print(data.head(), len(data))
# dataframe = data.iloc[:32455]
# validDataframe = data.iloc[32455:36455]
dataframe = data.iloc[:32455]
validDataframe = data.iloc[32455:36455]
# 初始化ViT处理器和BERT分词器
